...
<body>
    <div class="wrapper">
        <div class="main_box">
            ...
            <form id="proform" method="post" action="adminprochange" enctype="multipart/form-data" autocomplete="off">
            <input class="input_type" type="hidden" id="pro_id" name="pro_id" value="${product.pro_id}">
            <div class="login_input_box">
                <p class="input_exp">회사이름</p>
                <div class="input_type_box" id="input_pro_company_box">
                    <input class="input_type" type="text" id="pro_company" name="pro_company" value="${product.pro_company}"><br>
                </div>
                ...
                <div class="input_type_box" id="input_pro_name_box">
                    <input class="input_type" type="text" id="pro_name" name="pro_name" value="${product.pro_name}"><br>
                </div>
                ...
                <div class="input_type_box" id="input_pro_note_box">
                    <input class="input_type" type="text" id="pro_note" name="pro_note" value="${product.pro_note}"><br>
                </div>
                ...
                <div class="input_type_box" id="input_pro_stock_box">
                    <input class="input_type" type="number" id="pro_stock" name="pro_stock" value="${product.pro_stock}"><br>
                </div>
                ...
                <div class="input_type_box" id="input_pro_price_box">
                    <input class="input_type" type="number" id="pro_price" name="pro_price" value="${product.pro_price}"><br>
                </div>
                ...
                <div class="input_type_box" id="input_pro_saleprice_box">
                    <input class="input_type" type="number" id="pro_saleprice" name="pro_saleprice" value="${product.pro_saleprice}"><br>
                </div>
                <p class="input_exp input_ver_exp" id="pro_saleprice_ver_exp">&nbsp;</p>
                <p class="input_exp">상품사진</p>
                <c:if test="${picture!=null}">
                	<img class="pro_image" src="image/${product.pro_id}.jpg" width="100" height="100">
                </c:if>
