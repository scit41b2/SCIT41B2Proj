...
<body>
    <div class="wrapper">
        <div class="main_box">
            ...
            <form id="signupform" method="post" action="accupdate" autocomplete="off">
            <div class="login_input_box">
                <p class="input_exp">아이디</p>
                <div class="input_type_box" id="input_id_box">
                    <input class="input_type" type="text" id="acc_id" name="acc_id" value="${sessionScope.loginId}" readonly><br>
                </div>
                ...
                <div class="input_type_box" id="input_name_box">
                    <input class="input_type" type="text" id="acc_name" name="acc_name" value="${sessionScope.loginName}"><br>
                </div>
                <p class="input_exp input_ver_exp" id="name_ver_exp">&nbsp;</p>
                <p class="input_exp">주소</p>
                <div class="input_type_box" id="input_add_box">
                    <input class="input_type" type="text" id="acc_address" name="acc_address" value="${sessionScope.loginAdd}"><br>
                </div>
